...
class Commands(object):
    ...
    def startclient(self, mainclass, extraargs):
        ...
        extraargs = "-agentlib:jdwp=transport=dt_socket,server=y,suspend=y,address=5005 " + extraargs  # Add suspend=y
        print "Fork command:", forkcmd  # This will display the full command for debugging
        self.runmc(forkcmd)
