...
public class PathfinderGoalAvoidTarget<T extends Entity> extends PathfinderGoal
{
    ...
    public PathfinderGoalAvoidTarget(EntityCreature p_i1159_1_, Class<T> startDate, float banner, double endDate, double p_i1159_6_)
    {
        this(p_i1159_1_, startDate, Predicates.<T>alwaysTrue(), banner, endDate, p_i1159_6_);
    }
