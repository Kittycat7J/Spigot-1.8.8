...
public class EntityBat extends EntityAmbient
{
    ...
    public EntityBat(World p_i1210_1_)
    {
        super(p_i1210_1_);
    ...
    public void setAsleep(boolean p_setAsleep_1_)
    {
    ...
    protected void E()
    {
        ...
        else
        {
            ...
            float f = (float)(MathHelper.b(this.motZ, this.motX) * 180.0D / Math.PI) - 90.0F;
    ...
    {
        super.a(p_a_1_);
        this.datawatcher.watch(16, Byte.valueOf(p_a_1_.getByte("BatFlags")));
    }

    public void b(NBTTagCompound p_b_1_)
    {
        super.b(p_b_1_);
        p_b_1_.setByte("BatFlags", this.datawatcher.getByte(16));
    }
    ...
    private boolean a(Calendar p_a_1_)
    {
        return p_a_1_.get(2) + 1 == 10 && p_a_1_.get(5) >= 20 || p_a_1_.get(2) + 1 == 11 && p_a_1_.get(5) <= 3;
    }
