...
public class RecipesDyes
{
    public void a(CraftingManager p_a_1_)
    {
        for (int i = 0; i < 16; ++i)
        {
            ...
            p_a_1_.registerShapedRecipe(new ItemStack(Blocks.STAINED_HARDENED_CLAY, 8, 15 - i), new Object[] {"###", "#X#", "###", '#', new ItemStack(Blocks.HARDENED_CLAY), 'X', new ItemStack(Items.DYE, 1, i)});
            p_a_1_.registerShapedRecipe(new ItemStack(Blocks.STAINED_GLASS, 8, 15 - i), new Object[] {"###", "#X#", "###", '#', new ItemStack(Blocks.GLASS), 'X', new ItemStack(Items.DYE, 1, i)});
            p_a_1_.registerShapedRecipe(new ItemStack(Blocks.STAINED_GLASS_PANE, 16, i), new Object[] {"###", "###", '#', new ItemStack(Blocks.STAINED_GLASS, 1, i)});
        }
        ...
        for (int j = 0; j < 16; ++j)
        {
            p_a_1_.registerShapedRecipe(new ItemStack(Blocks.CARPET, 3, j), new Object[] {"##", '#', new ItemStack(Blocks.WOOL, 1, j)});
        }
    }
}
