...
public class EntityArrow extends Entity implements IProjectile
{
    ...
    public EntityArrow(World p_i289_1_, EntityLiving p_i289_2_, EntityLiving p_i289_3_, float p_i289_4_, float p_i289_5_)
    {
        ...
        if (d3 >= 1.0E-7D)
        {
            ...
            float f1 = (float)(-(MathHelper.b(d1, d3) * 180.0D / Math.PI));
            double d4 = d0 / d3;
            double d5 = d2 / d3;
    ...
    public void t_()
    {
        ...
        if (this.lastPitch == 0.0F && this.lastYaw == 0.0F)
        {
            ...
            this.lastYaw = this.yaw = (float)(MathHelper.b(this.motX, this.motZ) * 180.0D / Math.PI);
            this.lastPitch = this.pitch = (float)(MathHelper.b(this.motY, (double)f) * 180.0D / Math.PI);
        }
        ...
        else
        {
            ...
            for (this.pitch = (float)(MathHelper.b(this.motY, (double)f3) * 180.0D / Math.PI); this.pitch - this.lastPitch < -180.0F; this.lastPitch -= 360.0F)
            {
                ;
            }
