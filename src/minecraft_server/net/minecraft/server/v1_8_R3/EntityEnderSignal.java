...
public class EntityEnderSignal extends Entity
{
    ...
    public EntityEnderSignal(World p_i1245_1_)
    {
        super(p_i1245_1_);
    ...
    public EntityEnderSignal(World p_i1246_1_, double p_i1246_2_, double p_i1246_4_, double p_i1246_6_)
    {
        super(p_i1246_1_);
        this.d = 0;
        this.setSize(0.25F, 0.25F);
        this.setPosition(p_i1246_2_, p_i1246_4_, p_i1246_6_);
    }

    public void a(BlockPosition p_a_1_)
    {
        double d0 = (double)p_a_1_.getX();
        int i = p_a_1_.getY();
        double d1 = (double)p_a_1_.getZ();
