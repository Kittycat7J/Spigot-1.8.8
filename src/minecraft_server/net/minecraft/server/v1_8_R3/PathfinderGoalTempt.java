...
public class PathfinderGoalTempt extends PathfinderGoal
{
    ...
    public PathfinderGoalTempt(EntityCreature p_i1194_1_, double p_i1194_2_, Item p_i1194_4_, boolean p_i1194_5_)
    {
        this.a = p_i1194_1_;
        this.b = p_i1194_2_;
        this.k = p_i1194_4_;
        ...
        if (!(p_i1194_1_.getNavigation() instanceof Navigation))
        {
