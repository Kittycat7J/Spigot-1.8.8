...
public class PathfinderGoalMakeLove extends PathfinderGoal
{
    ...
    public PathfinderGoalMakeLove(EntityVillager p_i201_1_)
    {
        this.b = p_i201_1_;
        this.d = p_i201_1_.world;
        this.a(3);
    }
    ...
    public boolean a()
    {
        ...
        else
        {
            ...
            {
                Entity entity = this.d.a((Class)EntityVillager.class, (AxisAlignedBB)this.b.getBoundingBox().grow(8.0D, 3.0D, 8.0D), (Entity)this.b);
    ...
    private void g()
    {
        ...
        this.d.addEntity(entityvillager, SpawnReason.BREEDING);
