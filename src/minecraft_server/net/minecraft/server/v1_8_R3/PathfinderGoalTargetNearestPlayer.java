...
public class PathfinderGoalTargetNearestPlayer extends PathfinderGoal
{
    ...
    public PathfinderGoalTargetNearestPlayer(EntityInsentient p_i125_1_)
    {
        this.b = p_i125_1_;

        if (p_i125_1_ instanceof EntityCreature)
        {
        ...
        this.c = new Predicate()
        {
            public boolean a(Entity p_a_1_)
            {
                ...
                else if (((EntityHuman)p_a_1_).abilities.isInvulnerable)
                {
                    return false;
                }
                else
                {
                    ...
                    return (double)p_a_1_.g(PathfinderGoalTargetNearestPlayer.this.b) > d0 ? false : PathfinderGoalTarget.a(PathfinderGoalTargetNearestPlayer.this.b, (EntityLiving)p_a_1_, false, true);
                }
            }
        ...
        this.d = new PathfinderGoalNearestAttackableTarget.DistanceComparator(p_i125_1_);
    }
    ...
    public void c()
    {
        this.b.setGoalTarget(this.e, TargetReason.CLOSEST_PLAYER, true);
        super.c();
    }
