...
public class EntityGuardian extends EntityMonster
{
    ...
    public EntityGuardian(World p_i1239_1_)
    {
        super(p_i1239_1_);
        this.b_ = 10;
    ...
    {
        super.a(p_a_1_);
        this.setElder(p_a_1_.getBoolean("Elder"));
    }

    public void b(NBTTagCompound p_b_1_)
    {
        super.b(p_b_1_);
        p_b_1_.setBoolean("Elder", this.isElder());
    }

    protected NavigationAbstract b(World p_b_1_)
    {
        return new NavigationGuardian(this, p_b_1_);
    }
    ...
    private boolean a(int p_a_1_)
    {
        return (this.datawatcher.getInt(16) & p_a_1_) != 0;
    }

    private void a(int p_a_1_, boolean p_a_2_)
    {
        int i = this.datawatcher.getInt(16);

        if (p_a_2_)
        {
            this.datawatcher.watch(16, Integer.valueOf(i | p_a_1_));
        }
        else
        {
            this.datawatcher.watch(16, Integer.valueOf(i & ~p_a_1_));
    ...
    public void setElder(boolean p_setElder_1_)
    {
        this.a(4, p_setElder_1_);
    ...
    {
        this.datawatcher.watch(17, Integer.valueOf(p_b_1_));
    }
    ...
    {
        return this.world.getType(p_a_1_).getBlock().getMaterial() == Material.WATER ? 10.0F + this.world.o(p_a_1_) - 0.5F : super.a(p_a_1_);
    }
    ...
    public float q(float p_q_1_)
    {
        return ((float)this.bp + p_q_1_) / (float)this.cm();
    }
    ...
    protected void E()
    {
        ...
        if (this.isElder())
        {
            ...
            if ((this.ticksLived + this.getId()) % 1200 == 0)
            {
                ...
                for (EntityPlayer entityplayer : this.world.b(EntityPlayer.class, new Predicate<EntityPlayer>()
            {
                public boolean a(EntityPlayer p_a_1_)
                    {
                        return EntityGuardian.this.h(p_a_1_) < 2500.0D && p_a_1_.playerInteractManager.c();
                    }
                }))
                {
    ...
    {
        int i = this.random.nextInt(3) + this.random.nextInt(p_dropDeathLoot_2_ + 1);
        ...
        if (this.random.nextInt(3 + p_dropDeathLoot_2_) > 1)
        {
            this.a(new ItemStack(Items.FISH, 1, ItemFish.EnumFish.COD.a()), 1.0F);
        }
        else if (this.random.nextInt(3 + p_dropDeathLoot_2_) > 1)
        {
            this.a(new ItemStack(Items.PRISMARINE_CRYSTALS, 1, 0), 1.0F);
        }

        if (p_dropDeathLoot_1_ && this.isElder())
        {
    ...
    {
        return this.world.a((AxisAlignedBB)this.getBoundingBox(), (Entity)this) && this.world.getCubes(this, this.getBoundingBox()).isEmpty();
    }
    ...
    {
        if (!this.n() && !p_damageEntity_1_.isMagic() && p_damageEntity_1_.i() instanceof EntityLiving)
        {
            EntityLiving entityliving = (EntityLiving)p_damageEntity_1_.i();
    ...
    static class ControllerMoveGuardian extends ControllerMove
    {
        ...
        public ControllerMoveGuardian(EntityGuardian p_i1238_1_)
        {
            super(p_i1238_1_);
            this.g = p_i1238_1_;
        }
        ...
        public void c()
        {
            if (this.f && !this.g.getNavigation().m())
            {
                ...
                d1 = d1 / d3;
                float f = (float)(MathHelper.b(d2, d0) * 180.0D / Math.PI) - 90.0F;
                ...
                double d5 = Math.cos((double)(this.g.yaw * (float)Math.PI / 180.0F));
                double d6 = Math.sin((double)(this.g.yaw * (float)Math.PI / 180.0F));
                this.g.motX += d4 * d5;
                this.g.motZ += d4 * d6;
    ...
    static class EntitySelectorGuardianTargetHumanSquid implements Predicate<EntityLiving>
    {
        ...
        public EntitySelectorGuardianTargetHumanSquid(EntityGuardian p_i1237_1_)
        {
            this.a = p_i1237_1_;
        }
        ...
        {
            return (p_a_1_ instanceof EntityHuman || p_a_1_ instanceof EntitySquid) && p_a_1_.h(this.a) > 9.0D;
        }
    }
    ...
    static class PathfinderGoalGuardianAttack extends PathfinderGoal
    {
        ...
        public PathfinderGoalGuardianAttack(EntityGuardian p_i1236_1_)
        {
            this.a = p_i1236_1_;
            this.a(3);
        }
