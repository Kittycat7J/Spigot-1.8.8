...
public class BlockLeaves1 extends BlockLeaves
{
    ...
    {
        if (p_a_3_.get(VARIANT) == BlockWood.EnumLogVariant.OAK && p_a_1_.random.nextInt(p_a_4_) == 0)
        {
    ...
    {
        return p_d_1_.get(VARIANT) == BlockWood.EnumLogVariant.JUNGLE ? 40 : super.d(p_d_1_);
    }

    protected ItemStack i(IBlockData p_i_1_)
    {
        return new ItemStack(Item.getItemOf(this), 1, ((BlockWood.EnumLogVariant)p_i_1_.get(VARIANT)).a());
    }
    ...
    public void a(World p_a_1_, EntityHuman p_a_2_, BlockPosition p_a_3_, IBlockData p_a_4_, TileEntity p_a_5_)
    {
        if (!p_a_1_.isClientSide && p_a_2_.bZ() != null && p_a_2_.bZ().getItem() == Items.SHEARS)
        {
            ...
            a(p_a_1_, p_a_3_, new ItemStack(Item.getItemOf(this), 1, ((BlockWood.EnumLogVariant)p_a_4_.get(VARIANT)).a()));
        }
        else
        {
