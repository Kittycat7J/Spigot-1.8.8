...
public class EntityEnderDragon extends EntityInsentient implements IComplex, IMonster
{
    ...
    public void m()
    {
        ...
        {
            float f = MathHelper.cos(this.bv * (float)Math.PI * 2.0F);
            float f1 = MathHelper.cos(this.bu * (float)Math.PI * 2.0F);
        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    this.yaw = MathHelper.g(this.yaw);
                    double d13 = 180.0D - MathHelper.b(d0, d2) * 180.0D / Math.PI;
                    ...
                    double d15 = (double)(-MathHelper.cos(this.yaw * (float)Math.PI / 180.0F));
                    Vec3D vec3d1 = (new Vec3D((double)MathHelper.sin(this.yaw * (float)Math.PI / 180.0F), this.motY, d15)).a();
                ...
                this.bt.length = 3.0F;
                this.bt.width = 4.0F;
                float f18 = (float)(this.b(5, 1.0F)[1] - this.b(10, 1.0F)[1]) * 10.0F / 180.0F * (float)Math.PI;
                ...
                float f20 = MathHelper.sin(this.yaw * (float)Math.PI / 180.0F - this.bb * 0.01F);
                float f21 = MathHelper.cos(this.yaw * (float)Math.PI / 180.0F - this.bb * 0.01F);
                this.bn.t_();
                ...
                for (int j = 0; j < 3; ++j)
                {
                    ...
                    float f13 = this.yaw * (float)Math.PI / 180.0F + this.b(adouble2[0] - adouble[0]) * (float)Math.PI / 180.0F * 1.0F;
