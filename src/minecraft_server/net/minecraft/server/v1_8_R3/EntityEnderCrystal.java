...
public class EntityEnderCrystal extends Entity
{
    ...
    public EntityEnderCrystal(World p_i141_1_)
    {
        super(p_i141_1_);
        this.k = true;
    ...
    public void t_()
    {
        ...
        if (this.world.worldProvider instanceof WorldProviderTheEnd && this.world.getType(new BlockPosition(i, j, k)).getBlock() != Blocks.FIRE && !CraftEventFactory.callBlockIgniteEvent(this.world, i, j, k, (Entity)this).isCancelled())
        {
