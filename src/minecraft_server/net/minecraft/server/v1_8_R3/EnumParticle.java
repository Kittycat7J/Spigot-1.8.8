...
public enum EnumParticle {
   ...
   private final int T;
   private static final Map<Integer, EnumParticle> U = Maps.<Integer, EnumParticle>newHashMap();
   private static final String[] V;

   private EnumParticle(String p_i899_3_, int p_i899_4_, boolean p_i899_5_, int p_i899_6_) {
      this.Q = p_i899_3_;
      this.R = p_i899_4_;
      this.S = p_i899_5_;
      this.T = p_i899_6_;
   ...
   private EnumParticle(String p_i900_3_, int p_i900_4_, boolean p_i900_5_) {
      this(p_i900_3_, p_i900_4_, p_i900_5_, 0);
   }
   ...
   public static EnumParticle a(int p_a_0_) {
      return (EnumParticle)U.get(Integer.valueOf(p_a_0_));
   }
   ...
   static {
      ...
      for(EnumParticle enumparticle : values()) {
         U.put(Integer.valueOf(enumparticle.c()), enumparticle);
