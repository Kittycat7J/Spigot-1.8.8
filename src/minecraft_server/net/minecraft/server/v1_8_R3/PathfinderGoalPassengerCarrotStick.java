...
public class PathfinderGoalPassengerCarrotStick extends PathfinderGoal
{
    ...
    public PathfinderGoalPassengerCarrotStick(EntityInsentient p_i1162_1_, float p_i1162_2_)
    {
        this.a = p_i1162_1_;
        this.b = p_i1162_2_;
        this.a(7);
    ...
    public void e()
    {
        ...
        float fx = MathHelper.g(entityhuman.yaw - this.a.yaw) * 0.5F;
        ...
        this.a.yaw = MathHelper.g(this.a.yaw + fx);
        ...
        if (this.d)
        {
            ...
            f1 += f1 * 1.15F * MathHelper.sin((float)this.e / (float)this.f * (float)Math.PI);
        }
        ...
        float f4 = MathHelper.sin(entitycreature.yaw * (float)Math.PI / 180.0F);
        float f5 = MathHelper.cos(entitycreature.yaw * (float)Math.PI / 180.0F);
    ...
    private boolean a(Block p_a_1_)
    {
        return p_a_1_ instanceof BlockStairs || p_a_1_ instanceof BlockStepAbstract;
    }
