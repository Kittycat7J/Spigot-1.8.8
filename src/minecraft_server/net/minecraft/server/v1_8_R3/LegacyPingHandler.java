...
public class LegacyPingHandler extends ChannelInboundHandlerAdapter
{
    ...
    public LegacyPingHandler(ServerConnection p_i1076_1_)
    {
        this.b = p_i1076_1_;
    }
            ...
            if (bytebuf.readUnsignedByte() == 254)
            {
                ...
                switch (i)
                {
                    case 0:
                        ...
                        String s2 = String.format("%s\u00a7%d\u00a7%d", new Object[] {minecraftserver.getMotd(), Integer.valueOf(minecraftserver.I()), Integer.valueOf(minecraftserver.J())});
                        this.a(p_channelRead_1_, this.a(s2));
                        break;
                    ...
                    case 1:
                        ...
                        String s = String.format("\u00a71\u0000%d\u0000%s\u0000%s\u0000%d\u0000%d", new Object[] {Integer.valueOf(127), minecraftserver.getVersion(), minecraftserver.getMotd(), Integer.valueOf(minecraftserver.I()), Integer.valueOf(minecraftserver.J())});
                        this.a(p_channelRead_1_, this.a(s));
                        break;
                    ...
                    default:
                        ...
                        try
                        {
                            this.a(p_channelRead_1_, bytebuf1);
                        }
                        finally
                        {
                            bytebuf1.release();
    ...
    private void a(ChannelHandlerContext p_a_1_, ByteBuf p_a_2_)
    {
        p_a_1_.pipeline().firstContext().writeAndFlush(p_a_2_).addListener(ChannelFutureListener.CLOSE);
    }

    private ByteBuf a(String p_a_1_)
    {
        ByteBuf bytebuf = Unpooled.buffer();
        bytebuf.writeByte(255);
        char[] achar = p_a_1_.toCharArray();
