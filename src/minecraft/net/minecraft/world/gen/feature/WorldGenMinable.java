...
//       logger.info("custom logger WorldGenMinable: rand.nextFloat()");
...
//      logger.info("custom logger WorldGenMinable: rand.nextInt(3)\nrand.nextInt(3)");
...
//         logger.info("custom logger WorldGenMinable: rand.nextDouble()");
