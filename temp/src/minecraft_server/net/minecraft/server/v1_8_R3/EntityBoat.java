...
public class EntityBoat extends Entity {
   ...
   public void t_() {
      ...
      if(d6 > 0.2975D) {
         double d7 = Math.cos((double)this.yaw * 3.141592653589793D / 180.0D);
         double d8 = Math.sin((double)this.yaw * 3.141592653589793D / 180.0D);
      ...
      if(this.world.isClientSide && this.a) {
         ...
         if(d22 * d22 + d25 * d25 > 0.001D) {
            d19 = (double)((float)(MathHelper.b(d25, d22) * 180.0D / 3.141592653589793D));
         }
