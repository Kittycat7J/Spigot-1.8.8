...
public class GenLayerZoomVoronoi extends GenLayer {
   public GenLayerZoomVoronoi(long p_i830_1_, GenLayer p_i830_3_) {
      super(p_i830_1_);
      super.a = p_i830_3_;
   }
   ...
   public int[] a(int p_a_1_, int p_a_2_, int p_a_3_, int p_a_4_) {
      ...
      for(int l3 = 0; l3 < p_a_4_; ++l3) {
         System.arraycopy(aint1, (l3 + (p_a_2_ & 3)) * i1 + (p_a_1_ & 3), aint2, l3 * p_a_3_, p_a_3_);
      }
