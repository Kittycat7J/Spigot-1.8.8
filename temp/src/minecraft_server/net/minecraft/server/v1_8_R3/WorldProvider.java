...
import net.minecraft.server.v1_8_R3.ChunkProviderFlat;
...
import net.minecraft.server.v1_8_R3.WorldGenFlatInfo;
...
public abstract class WorldProvider {
   ...
   public float a(long p_a_1_, float p_a_3_) {
      ...
      fx = 1.0F - (float)((Math.cos((double)fx * 3.141592653589793D) + 1.0D) / 2.0D);
      fx = fx + (fx - fx) / 3.0F;
      return fx;
   }
