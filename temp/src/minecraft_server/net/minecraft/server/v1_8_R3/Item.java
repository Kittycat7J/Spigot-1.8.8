...
import net.minecraft.server.v1_8_R3.ItemCoal;
import net.minecraft.server.v1_8_R3.ItemDoor;
import net.minecraft.server.v1_8_R3.ItemDye;
import net.minecraft.server.v1_8_R3.ItemEgg;
...
import net.minecraft.server.v1_8_R3.ItemExpBottle;
import net.minecraft.server.v1_8_R3.ItemFireball;
...
import net.minecraft.server.v1_8_R3.ItemFlintAndSteel;
import net.minecraft.server.v1_8_R3.ItemFood;
import net.minecraft.server.v1_8_R3.ItemGlassBottle;
...
import net.minecraft.server.v1_8_R3.ItemMilkBucket;
...
import net.minecraft.server.v1_8_R3.ItemTallPlant;
import net.minecraft.server.v1_8_R3.ItemWaterLily;
...
public class Item {
   ...
   private static final Map<Block, Item> a = Maps.<Block, Item>newHashMap();
   ...
   public static int getId(Item p_getId_0_) {
      return p_getId_0_ == null?0:REGISTRY.b(p_getId_0_);
   }

   public static Item getById(int p_getById_0_) {
      return (Item)REGISTRY.a(p_getById_0_);
   }

   public static Item getItemOf(Block p_getItemOf_0_) {
      return (Item)a.get(p_getItemOf_0_);
   }

   public static Item d(String p_d_0_) {
      Item item = (Item)REGISTRY.get(new MinecraftKey(p_d_0_));
      if(item == null) {
         try {
            return getById(Integer.parseInt(p_d_0_));
   ...
   public boolean a(NBTTagCompound p_a_1_) {
      return false;
   }

   public Item c(int p_c_1_) {
      this.maxStackSize = p_c_1_;
      return this;
   }
   ...
   protected Item a(boolean p_a_1_) {
      this.j = p_a_1_;
      return this;
   }
   ...
   protected Item setMaxDurability(int p_setMaxDurability_1_) {
      this.durability = p_setMaxDurability_1_;
      return this;
   }
   ...
   public Item c(String p_c_1_) {
      this.name = p_c_1_;
      return this;
   }

   public String k(ItemStack p_k_1_) {
      String s = this.e_(p_k_1_);
   ...
   public Item c(Item p_c_1_) {
      this.craftingResult = p_c_1_;
      return this;
   }
   ...
   protected Item e(String p_e_1_) {
      this.k = p_e_1_;
      return this;
   }
   ...
   public boolean l(ItemStack p_l_1_) {
      return this.j(p_l_1_) != null;
   }

   public String a(ItemStack p_a_1_) {
      return ("" + LocaleI18n.get(this.k(p_a_1_) + ".name")).trim();
   }

   public EnumItemRarity g(ItemStack p_g_1_) {
      return p_g_1_.hasEnchantments()?EnumItemRarity.RARE:EnumItemRarity.COMMON;
   }
   ...
   protected MovingObjectPosition a(World p_a_1_, EntityHuman p_a_2_, boolean p_a_3_) {
      float fx = p_a_2_.pitch;
      float f1 = p_a_2_.yaw;
      double d0 = p_a_2_.locX;
      double d1 = p_a_2_.locY + (double)p_a_2_.getHeadHeight();
      double d2 = p_a_2_.locZ;
      Vec3D vec3d = new Vec3D(d0, d1, d2);
      float f2 = MathHelper.cos(-f1 * 0.017453292F - 3.1415927F);
      float f3 = MathHelper.sin(-f1 * 0.017453292F - 3.1415927F);
      float f4 = -MathHelper.cos(-fx * 0.017453292F);
      float f5 = MathHelper.sin(-fx * 0.017453292F);
      float f6 = f3 * f4;
      float f7 = f2 * f4;
      double d3 = 5.0D;
      Vec3D vec3d1 = vec3d.add((double)f6 * d3, (double)f5 * d3, (double)f7 * d3);
      return p_a_1_.rayTrace(vec3d, vec3d1, p_a_3_, !p_a_3_, false);
   }
   ...
   public Item a(CreativeModeTab p_a_1_) {
      this.b = p_a_1_;
      return this;
   }
   ...
   public static void t() {
      a((Block)Blocks.STONE, (Item)(new ItemMultiTexture(Blocks.STONE, Blocks.STONE, new Function<ItemStack, String>() {
         public String a(ItemStack p_a_1_) {
            return BlockStone.EnumStoneVariant.a(p_a_1_.getData()).d();
         }
      })).b("stone"));
      a((Block)Blocks.GRASS, (Item)(new ItemWithAuxData(Blocks.GRASS, false)));
      a((Block)Blocks.DIRT, (Item)(new ItemMultiTexture(Blocks.DIRT, Blocks.DIRT, new Function<ItemStack, String>() {
         public String a(ItemStack p_a_1_) {
            return BlockDirt.EnumDirtVariant.a(p_a_1_.getData()).c();
         }
      })).b("dirt"));
      c(Blocks.COBBLESTONE);
      a((Block)Blocks.PLANKS, (Item)(new ItemMultiTexture(Blocks.PLANKS, Blocks.PLANKS, new Function<ItemStack, String>() {
         public String a(ItemStack p_a_1_) {
            return BlockWood.EnumLogVariant.a(p_a_1_.getData()).d();
         }
      })).b("wood"));
      a((Block)Blocks.SAPLING, (Item)(new ItemMultiTexture(Blocks.SAPLING, Blocks.SAPLING, new Function<ItemStack, String>() {
         public String a(ItemStack p_a_1_) {
            return BlockWood.EnumLogVariant.a(p_a_1_.getData()).d();
         }
      })).b("sapling"));
      c(Blocks.BEDROCK);
      a((Block)Blocks.SAND, (Item)(new ItemMultiTexture(Blocks.SAND, Blocks.SAND, new Function<ItemStack, String>() {
         public String a(ItemStack p_a_1_) {
            return BlockSand.EnumSandVariant.a(p_a_1_.getData()).d();
         }
      })).b("sand"));
      c(Blocks.GRAVEL);
      c(Blocks.GOLD_ORE);
      c(Blocks.IRON_ORE);
      c(Blocks.COAL_ORE);
      a((Block)Blocks.LOG, (Item)(new ItemMultiTexture(Blocks.LOG, Blocks.LOG, new Function<ItemStack, String>() {
         public String a(ItemStack p_a_1_) {
            return BlockWood.EnumLogVariant.a(p_a_1_.getData()).d();
         }
      })).b("log"));
      a((Block)Blocks.LOG2, (Item)(new ItemMultiTexture(Blocks.LOG2, Blocks.LOG2, new Function<ItemStack, String>() {
         public String a(ItemStack p_a_1_) {
            return BlockWood.EnumLogVariant.a(p_a_1_.getData() + 4).d();
         }
      })).b("log"));
      ...
      a((Block)Blocks.SPONGE, (Item)(new ItemMultiTexture(Blocks.SPONGE, Blocks.SPONGE, new Function<ItemStack, String>() {
         public String a(ItemStack p_a_1_) {
            return (p_a_1_.getData() & 1) == 1?"wet":"dry";
         }
      })).b("sponge"));
      c(Blocks.GLASS);
      c(Blocks.LAPIS_ORE);
      ...
      c(Blocks.DISPENSER);
      a((Block)Blocks.SANDSTONE, (Item)(new ItemMultiTexture(Blocks.SANDSTONE, Blocks.SANDSTONE, new Function<ItemStack, String>() {
         public String a(ItemStack p_a_1_) {
            return BlockSandStone.EnumSandstoneVariant.a(p_a_1_.getData()).c();
         }
      })).b("sandStone"));
      c(Blocks.NOTEBLOCK);
      ...
      a((Block)Blocks.YELLOW_FLOWER, (Item)(new ItemMultiTexture(Blocks.YELLOW_FLOWER, Blocks.YELLOW_FLOWER, new Function<ItemStack, String>() {
         public String a(ItemStack p_a_1_) {
            return BlockFlowers.EnumFlowerVarient.a(BlockFlowers.EnumFlowerType.YELLOW, p_a_1_.getData()).d();
         }
      })).b("flower"));
      a((Block)Blocks.RED_FLOWER, (Item)(new ItemMultiTexture(Blocks.RED_FLOWER, Blocks.RED_FLOWER, new Function<ItemStack, String>() {
         public String a(ItemStack p_a_1_) {
            return BlockFlowers.EnumFlowerVarient.a(BlockFlowers.EnumFlowerType.RED, p_a_1_.getData()).d();
         }
      })).b("rose"));
      ...
      c(Blocks.TRAPDOOR);
      a((Block)Blocks.MONSTER_EGG, (Item)(new ItemMultiTexture(Blocks.MONSTER_EGG, Blocks.MONSTER_EGG, new Function<ItemStack, String>() {
         public String a(ItemStack p_a_1_) {
            return BlockMonsterEggs.EnumMonsterEggVarient.a(p_a_1_.getData()).c();
         }
      })).b("monsterStoneEgg"));
      a((Block)Blocks.STONEBRICK, (Item)(new ItemMultiTexture(Blocks.STONEBRICK, Blocks.STONEBRICK, new Function<ItemStack, String>() {
         public String a(ItemStack p_a_1_) {
            return BlockSmoothBrick.EnumStonebrickType.a(p_a_1_.getData()).c();
         }
      })).b("stonebricksmooth"));
      ...
      a((Block)Blocks.COBBLESTONE_WALL, (Item)(new ItemMultiTexture(Blocks.COBBLESTONE_WALL, Blocks.COBBLESTONE_WALL, new Function<ItemStack, String>() {
         public String a(ItemStack p_a_1_) {
            return BlockCobbleWall.EnumCobbleVariant.a(p_a_1_.getData()).c();
         }
      })).b("cobbleWall"));
      ...
      c(Blocks.SLIME);
      a((Block)Blocks.DOUBLE_PLANT, (Item)(new ItemTallPlant(Blocks.DOUBLE_PLANT, Blocks.DOUBLE_PLANT, new Function<ItemStack, String>() {
         public String a(ItemStack p_a_1_) {
            return BlockTallPlant.EnumTallFlowerVariants.a(p_a_1_.getData()).c();
         }
      })).b("doublePlant"));
      ...
      a((Block)Blocks.PRISMARINE, (Item)(new ItemMultiTexture(Blocks.PRISMARINE, Blocks.PRISMARINE, new Function<ItemStack, String>() {
         public String a(ItemStack p_a_1_) {
            return BlockPrismarine.EnumPrismarineVariant.a(p_a_1_.getData()).c();
         }
      })).b("prismarine"));
      c(Blocks.SEA_LANTERN);
      a((Block)Blocks.RED_SANDSTONE, (Item)(new ItemMultiTexture(Blocks.RED_SANDSTONE, Blocks.RED_SANDSTONE, new Function<ItemStack, String>() {
         public String a(ItemStack p_a_1_) {
            return BlockRedSandstone.EnumRedSandstoneVariant.a(p_a_1_.getData()).c();
         }
      })).b("redSandStone"));
      ...
      a(325, (String)"bucket", item);
      a(326, (String)"water_bucket", (new ItemBucket(Blocks.FLOWING_WATER)).c("bucketWater").c(item));
      a(327, (String)"lava_bucket", (new ItemBucket(Blocks.FLOWING_LAVA)).c("bucketLava").c(item));
      ...
      a(335, (String)"milk_bucket", (new ItemMilkBucket()).c("milk").c(item));
   ...
   private static void c(Block p_c_0_) {
      a((Block)p_c_0_, (Item)(new ItemBlock(p_c_0_)));
   }

   protected static void a(Block p_a_0_, Item p_a_1_) {
      a(Block.getId(p_a_0_), (MinecraftKey)Block.REGISTRY.c(p_a_0_), p_a_1_);
      a.put(p_a_0_, p_a_1_);
   }

   private static void a(int p_a_0_, String p_a_1_, Item p_a_2_) {
      a(p_a_0_, new MinecraftKey(p_a_1_), p_a_2_);
   }

   private static void a(int p_a_0_, MinecraftKey p_a_1_, Item p_a_2_) {
   ...
   public static enum EnumToolMaterial {
      ...
      private EnumToolMaterial(int p_i1283_3_, int p_i1283_4_, float p_i1283_5_, float p_i1283_6_, int p_i1283_7_) {
         this.f = p_i1283_3_;
         this.g = p_i1283_4_;
         this.h = p_i1283_5_;
         this.i = p_i1283_6_;
