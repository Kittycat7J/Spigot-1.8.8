...
public class RecipesBanner {
   void a(CraftingManager p_a_1_) {
      for(EnumColor enumcolor : EnumColor.values()) {
         p_a_1_.registerShapedRecipe(new ItemStack(Items.BANNER, 1, enumcolor.getInvColorIndex()), new Object[]{"###", "###", " | ", Character.valueOf('#'), new ItemStack(Blocks.WOOL, 1, enumcolor.getColorIndex()), Character.valueOf('|'), Items.STICK});
      }
