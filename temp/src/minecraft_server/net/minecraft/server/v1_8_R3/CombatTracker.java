...
import net.minecraft.server.v1_8_R3.CombatEntry;
...
public class CombatTracker {
   private final List<CombatEntry> a = Lists.<CombatEntry>newArrayList();
   ...
   public CombatTracker(EntityLiving p_i1132_1_) {
      this.b = p_i1132_1_;
   }
   ...
   public void a(DamageSource p_a_1_, float p_a_2_, float p_a_3_) {
      this.g();
      this.a();
      CombatEntry combatentry = new CombatEntry(p_a_1_, this.b.ticksLived, p_a_2_, p_a_3_, this.h, this.b.fallDistance);
         ...
         if(combatentry != null && combatentry1.a() == DamageSource.FALL) {
            ...
            if(combatentry.a() != DamageSource.FALL && combatentry.a() != DamageSource.OUT_OF_WORLD) {
               if(ichatbasecomponent1 != null && (ichatbasecomponent == null || !ichatbasecomponent1.equals(ichatbasecomponent))) {
                  ...
                  ItemStack itemstack1 = entity1 instanceof EntityLiving?((EntityLiving)entity1).bA():null;
                  if(itemstack1 != null && itemstack1.hasName()) {
                     object = new ChatMessage("death.fell.assist.item", new Object[]{this.b.getScoreboardDisplayName(), ichatbasecomponent1, itemstack1.C()});
                  } else {
                  ...
                  ItemStack itemstack = entity instanceof EntityLiving?((EntityLiving)entity).bA():null;
                  if(itemstack != null && itemstack.hasName()) {
                     object = new ChatMessage("death.fell.finish.item", new Object[]{this.b.getScoreboardDisplayName(), ichatbasecomponent, itemstack.C()});
                  } else {
   ...
   private CombatEntry i() {
      ...
      for(int i = 0; i < this.a.size(); ++i) {
         ...
         if((combatentry2.a() == DamageSource.FALL || combatentry2.a() == DamageSource.OUT_OF_WORLD) && combatentry2.i() > 0.0F && (combatentry == null || combatentry2.i() > fx)) {
            if(i > 0) {
   ...
   private String a(CombatEntry p_a_1_) {
      return p_a_1_.g() == null?"generic":p_a_1_.g();
   }
