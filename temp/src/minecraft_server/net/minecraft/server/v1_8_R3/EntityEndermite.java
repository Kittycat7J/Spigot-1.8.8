...
public class EntityEndermite extends EntityMonster {
   ...
   public EntityEndermite(World p_i1233_1_) {
      super(p_i1233_1_);
      this.b_ = 3;
   ...
   public void a(NBTTagCompound p_a_1_) {
      super.a(p_a_1_);
      this.a = p_a_1_.getInt("Lifetime");
      this.b = p_a_1_.getBoolean("PlayerSpawned");
   }

   public void b(NBTTagCompound p_b_1_) {
      super.b(p_b_1_);
      p_b_1_.setInt("Lifetime", this.a);
      p_b_1_.setBoolean("PlayerSpawned", this.b);
   }
