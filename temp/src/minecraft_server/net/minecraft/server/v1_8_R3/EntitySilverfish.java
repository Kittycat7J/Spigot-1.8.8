...
public class EntitySilverfish extends EntityMonster {
   ...
   public EntitySilverfish(World p_i45_1_) {
      super(p_i45_1_);
   ...
   public boolean damageEntity(DamageSource p_damageEntity_1_, float p_damageEntity_2_) {
      if(this.isInvulnerable(p_damageEntity_1_)) {
         ...
         if(p_damageEntity_1_ instanceof EntityDamageSource || p_damageEntity_1_ == DamageSource.MAGIC) {
            this.a.f();
         }
   ...
   public float a(BlockPosition p_a_1_) {
      return this.world.getType(p_a_1_.down()).getBlock() == Blocks.STONE?10.0F:super.a(p_a_1_);
   }
   ...
   static class PathfinderGoalSilverfishHideInBlock extends PathfinderGoalRandomStroll {
      ...
      public PathfinderGoalSilverfishHideInBlock(EntitySilverfish p_i364_1_) {
         super(p_i364_1_, 1.0D, 10);
         this.silverfish = p_i364_1_;
         this.a(1);
      }
   ...
   static class PathfinderGoalSilverfishWakeOthers extends PathfinderGoal {
      ...
      public PathfinderGoalSilverfishWakeOthers(EntitySilverfish p_i260_1_) {
         this.silverfish = p_i260_1_;
      }
