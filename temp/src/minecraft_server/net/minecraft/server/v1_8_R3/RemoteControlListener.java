...
import net.minecraft.server.v1_8_R3.RemoteControlSession;
...
public class RemoteControlListener extends RemoteConnectionThread {
   ...
   public RemoteControlListener(IMinecraftServer p_i1096_1_) {
      super(p_i1096_1_, "RCON Listener");
      this.h = p_i1096_1_.a("rcon.port", 0);
      this.l = p_i1096_1_.a("rcon.password", "");
      this.j = p_i1096_1_.E();
      this.i = p_i1096_1_.F();
      if(0 == this.h) {
         this.h = this.i + 10;
         this.b("Setting default rcon port to " + this.h);
         p_i1096_1_.a("rcon.port", (Object)Integer.valueOf(this.h));
         if(0 == this.l.length()) {
            p_i1096_1_.a("rcon.password", (Object)"");
         }
   ...
   private void f() {
      this.m = Maps.<SocketAddress, RemoteControlSession>newHashMap();
   }
