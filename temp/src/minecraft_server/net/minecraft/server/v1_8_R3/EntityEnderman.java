...
public class EntityEnderman extends EntityMonster {
   ...
   public void a(NBTTagCompound p_a_1_) {
      ...
      if(p_a_1_.hasKeyOfType("carried", 8)) {
         iblockdata = Block.getByName(p_a_1_.getString("carried")).fromLegacyData(p_a_1_.getShort("carriedData") & '\uffff');
      } else {
         iblockdata = Block.getById(p_a_1_.getShort("carried")).fromLegacyData(p_a_1_.getShort("carriedData") & '\uffff');
      }
   ...
   public void setCarried(IBlockData p_setCarried_1_) {
      this.datawatcher.watch(16, Short.valueOf((short)(Block.getCombinedId(p_setCarried_1_) & '\uffff')));
   }
