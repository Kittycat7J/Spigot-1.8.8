...
import net.minecraft.server.v1_8_R3.RecipeIngots;
...
import net.minecraft.server.v1_8_R3.RecipesArmor;
import net.minecraft.server.v1_8_R3.RecipesBanner;
import net.minecraft.server.v1_8_R3.RecipesCrafting;
import net.minecraft.server.v1_8_R3.RecipesDyes;
import net.minecraft.server.v1_8_R3.RecipesFood;
import net.minecraft.server.v1_8_R3.RecipesTools;
import net.minecraft.server.v1_8_R3.RecipesWeapons;
